				...
				<form action="/update/${motobike.motobikeId }" method="POST">
					...
					<div class="form-group">
						<label for="exampleInputPassword1">Loại xe</label> <select
							class="form-control" name="motobikeType">
							<c:forEach var="motobikeType" items="${motobikeTypes}">
								<c:choose>
									<c:when test="${motobike.motobikeType == motobikeType}">
										<option value="${motobikeType}" selected>${motobikeType}</option>
									</c:when>
									<c:otherwise>
					...
					<div class="form-group">
						<label for="exampleInputPassword1">Màu xe</label> <select
							class="form-control" name="motobikeColor">
							<c:forEach var="motobikeColor" items="${motobikeColors}">
								<c:choose>
									<c:when test="${motobike.motobikeColor == motobikeColor}">
										<option value="${motobikeColor}" selected>${motobikeColor}</option>
									</c:when>
									<c:otherwise>
					...
					<div class="form-group">
						<label for="exampleInputPassword1">Hãng xe</label> <select
							class="form-control" name="motobikeCompany">
							<c:forEach var="motobikeCompany" items="${motobikeCompanys}">
								<c:choose>
									<c:when test="${motobike.motobikeCompany == motobikeCompany}">
										<option value="${motobikeCompany}" selected>${motobikeCompany}</option>
									</c:when>
									<c:otherwise>
